...
public interface BiliAppService {
    ...
    @GET("Application/Bilibili/Test?service=BiliAppService&action=getRecommendedInfo")
    ...
    @GET("Application/Bilibili/Test?service=BiliAppService&action=getRecommendedBannerInfo")
    ...
    @GET("Application/Bilibili/Test?service=BiliAppService&action=getVideoDetails")
