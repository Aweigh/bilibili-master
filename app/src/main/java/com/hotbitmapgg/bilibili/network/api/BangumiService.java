...
public interface BangumiService {
    ...
    @GET("Application/Bilibili/Test?service=BangumiService&action=getBangumiAppIndex&t=201805231527")
    ...
    @GET("Application/Bilibili/Test?service=BangumiService&action=getBangumiDetailsRecommend&t=201805231526")
    ...
    @GET("Application/Bilibili/Test?service=BangumiService&action=getBangumiDetails")
    ...
    @GET("Application/Bilibili/Test?service=BangumiService&action=getBangumiRecommended&t=201805221526")
    ...
    @GET("Application/Bilibili/Test?service=BangumiService&action=getSeasonNewBangumiList&t=201805221526")
    ...
    @GET("Application/Bilibili/Test?service=BangumiService&action=getBangumiSchedules&t=201805221526")
    ...
    @GET("Application/Bilibili/Test?service=BangumiService&action=getBangumiIndex&t=201805221526")
