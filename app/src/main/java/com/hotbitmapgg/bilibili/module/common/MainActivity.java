...
public class MainActivity extends RxBaseActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private void initFragments() {
        mHomePageFragment = HomePageFragment.newInstance();//主页fragment
        /*by="Aweigh" date="2018/4/27 15:20"
          下面构造NavigationView中的Fragment数组
        */
    ...
    ///<summary>侧滑菜单NavigationView不同项的切换事件</summary>
    @Override
